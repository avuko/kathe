...
SORTED_SET_LIMIT = 2000
CONTEXT_SET_LIMIT = 16000
        ...
        for ssdeep in rdb.zscan_iter(cachename):
            ...
            for k in alllinks:
                ...
                if rdb.zscore(cachename, linkssdeep):
                    newlink = {'source': rdb.zrank(cachename, ssdeep), 'target': rdb.zrank(cachename, linkssdeep), 'value': (k[1] / float(10)), 'ssdeepcompare': k[1]}
